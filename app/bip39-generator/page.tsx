            ...
            <div className="bg-[#002b47] border border-[#00416a] rounded-md p-6 sm:p-8 shadow-sm">
                <div className="flex flex-wrap gap-6 mb-8 items-end">
                    <div className="flex-1 max-w-sm">
                        <label className="block text-[15px] text-cyan-100 mb-2">Word count</label>
                        <select
                            value={wordCount}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mb-8">
                    {words.map((word, index) => (
                        <div key={index} className="flex bg-[#00416a] border border-[#00558c] rounded-md overflow-hidden">
                            <div className="w-10 bg-[#00558c] flex items-center justify-center text-cyan-300/50 font-medium border-r border-[#00558c] select-none text-sm shrink-0">
                                {index + 1}
                            </div>
